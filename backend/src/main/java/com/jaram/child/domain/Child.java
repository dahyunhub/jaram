...
public class Child extends BaseTimeEntity {
    ...
    private Child(Long classroomId, String name, LocalDate birthDate, String tokenAlias) {
    ...
    public static Child create(Long classroomId, String name, LocalDate birthDate, String tokenAlias) {
        return new Child(classroomId, name, birthDate, tokenAlias);
    }
